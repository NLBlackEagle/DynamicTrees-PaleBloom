...
import maxhyper.dynamictreesdefiledlands.trees.TreePaleOak;
...
public class ModContent {
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event) {
        ...
        LeavesPaging.getLeavesBlockForSequence(DynamicTreesDefiledLands.MODID, 0, paleOakLeavesProperties);
    ...
    public static void registerModels(ModelRegistryEvent event) {
        ...
        LeavesPaging.getLeavesMapForModId(DynamicTreesDefiledLands.MODID).forEach((key, leaves) ->
